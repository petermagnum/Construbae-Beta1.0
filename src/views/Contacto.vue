    ...
    <v-layout wrap>
      <v-flex class="mt-5" xs12>
        ...
        <h2 class="ml-5 mr-5 mb-5 mt-5" align="justify">
          Escríbanos y cuéntenos en qué podemos asesorarlo.
        </h2>
      </v-flex>
        ...
        <v-row class="pa-15 justify-center">
          <v-card elevation="10" shaped class="blue--text" width="900">
            <v-card-title class="ml-8"
              >Ingrese sus datos personales:</v-card-title
            >
      ...
      <v-flex class="mt-5" xs6>
        ...
        <h4 class="ml-5 mr-5 mb-5 mt-5" align="center">
          José Reyes Morales #2090, Temuco
        </h4>
        <h4 class="ml-5 mr-5 mb-5 mt-5" align="center">
          contacto@construbae.cl
        </h4>
    ...
    async enviarContacto(contacto) {
      ...
      try {
        const res = await fetch(
          `https://webproyect-27e28-default-rtdb.firebaseio.com/contacto/${this.contacto.id}.json`,
          {
            method: "PUT",
            header: {
        ...
        console.log(dataDB);
        alert("Informacion de contacto enviada con exito!");
        this.contacto = {
          id: "",
          nombres: "",
          apellidos: "",
